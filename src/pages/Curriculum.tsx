...
import { ArrowLeft, GraduationCap, Briefcase, Award, MapPin, Mail, Phone, Globe, Scale, BookOpen, Languages } from "lucide-react";
...
const education = [
  {
    ...
    period: "2016 – 2020",
    description: "Formación integral en las distintas ramas del ordenamiento jurídico español y europeo.",
  },
  {
    title: "Máster en Abogacía",
    institution: "Universidad de Alicante",
    period: "2020 – 2021",
    description: "Habilitación profesional para el ejercicio de la abogacía. Prácticas en despacho.",
  },
];

const experience = [
  {
    title: "Fundador — Avendaño Serrano Abogados",
    period: "2023 – Presente",
    description: "Dirección y gestión integral del despacho. Asesoramiento jurídico en derecho civil, laboral, extranjería, penal y mercantil.",
  },
  {
    title: "Abogado colaborador",
    period: "2021 – 2023",
    description: "Ejercicio profesional en diversas áreas del derecho, con especial dedicación al derecho de extranjería y derecho civil.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-6 md:px-12 py-16 space-y-16">
        {/* Perfil profesional */}
        <section>
          <SectionTitle icon={BookOpen} title="Perfil Profesional" />
          <p className="font-body text-base leading-relaxed text-muted-foreground max-w-3xl">
            Abogado ejerciente con vocación por el servicio al cliente, especializado en derecho de extranjería, 
            derecho civil y derecho laboral. Fundador de Avendaño Serrano Abogados, un despacho comprometido con 
            ofrecer asesoramiento legal de calidad a precios accesibles en la provincia de Alicante. 
            Orientado a resultados y con una fuerte capacidad de negociación y resolución de conflictos.
          </p>
        </section>
        ...
        {/* Formación */}
        <section>
          <SectionTitle icon={GraduationCap} title="Formación Académica" />
          <div className="space-y-8">
            {education.map((item) => (
        ...
        {/* Áreas de práctica */}
        <section>
          <SectionTitle icon={Award} title="Áreas de Especialización" />
