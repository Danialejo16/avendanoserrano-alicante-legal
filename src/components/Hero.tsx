      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-20 pt-20">
        <div className="max-w-2xl">
          ...
          <h1
            ...
            style={{ color: "hsl(40, 33%, 97%)", animationDelay: "0.3s", opacity: 0 }}
          >
            Defendemos sus derechos con{" "}
            <span className="text-gold italic">compromiso</span> y{" "}
            <span className="text-gold italic">excelencia</span>
          </h1>

          <p
            className="text-lg md:text-xl font-body leading-relaxed mb-10 animate-fade-in-up"
            style={{ color: "hsl(40, 20%, 80%)", animationDelay: "0.5s", opacity: 0 }}
          >
          ...
          >
            <a
              href="#contacto"
              className="gold-gradient text-accent-foreground px-8 py-4 rounded text-base font-semibold hover:opacity-90 transition-opacity text-center"
            >
              Consulta gratuita
            </a>
            <a
              href="#servicios"
              className="border border-gold/40 px-8 py-4 rounded text-base font-semibold hover:bg-gold/10 transition-colors text-center"
