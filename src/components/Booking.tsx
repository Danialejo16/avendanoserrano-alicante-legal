  ...
  return (
    <section id="citas" className="section-padding bg-secondary/10">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={submit} className="bg-card border border-border rounded-lg p-6 md:p-8 space-y-6">
          <div>
          ...
          <Button type="submit" disabled={submitting} className="w-full accent-gradient text-accent-foreground py-6 text-base font-semibold">
            {submitting ? <Loader2 className="w-4 h-4 animate-spin" /> : "Reservar cita"}
          </Button>
        </form>
      </div>
    </section>
